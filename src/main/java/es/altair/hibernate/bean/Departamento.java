...
public class Departamento implements Serializable{
	...
	@Length(min = 2, max = 30)
	@Pattern(regexp="[A-Z]{1}[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,29}", message="El nombre del departament tiene que empiezar por letra maiuscula")
	private String descripcion;
	
	@OneToMany(mappedBy = "departamento", cascade=CascadeType.DETACH, fetch = FetchType.LAZY) // conexion con tabla empleados
